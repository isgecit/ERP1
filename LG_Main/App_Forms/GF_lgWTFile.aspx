<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="GF_lgWTFile.aspx.vb" Inherits="GF_lgWTFile" title="Maintain List: WT File Details" %>
