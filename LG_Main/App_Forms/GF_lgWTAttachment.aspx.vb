Partial Class GF_lgWTAttachment
  Inherits SIS.SYS.GridBase
  Private _InfoUrl As String = "~/LG_Main/App_Display/DF_lgWTAttachment.aspx"
  ...
  Protected Sub GVlgWTAttachment_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles GVlgWTAttachment.Init
    DataClassName = "GlgWTAttachment"
    SetGridView = GVlgWTAttachment
  End Sub
  ...
  Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
    ...
    End If
		...
		Dim validateScriptDocPK As String = "<script type=""text/javascript"">" & _
			...
			"    validated_FK_LG_WTAttachment_DocPK_main = true;" & _
			"    validate_FK_LG_WTAttachment_DocPK(o);" & _
			"  }" & _
		  "</script>"
		...
		End If
		Dim validateScriptFK_LG_WTAttachment_DocPK As String = "<script type=""text/javascript"">" & _
			"  function validate_FK_LG_WTAttachment_DocPK(o) {" & _
			"    var value = o.id;" & _
			"    var DocPK = $get('" & F_DocPK.ClientID & "');" & _
			"    try{" & _
			"    if(DocPK.value==''){" & _
			"      if(validated_FK_LG_WTAttachment_DocPK.main){" & _
			...
			"    PageMethods.validate_FK_LG_WTAttachment_DocPK(value, validated_FK_LG_WTAttachment_DocPK);" & _
			"  }" & _
			"  validated_FK_LG_WTAttachment_DocPK_main = false;" & _
			"  function validated_FK_LG_WTAttachment_DocPK(result) {" & _
			...
			"  }" & _
		  "</script>"
		If Not Page.ClientScript.IsClientScriptBlockRegistered("validateFK_LG_WTAttachment_DocPK") Then
			Page.ClientScript.RegisterClientScriptBlock(GetType(System.String), "validateFK_LG_WTAttachment_DocPK", validateScriptFK_LG_WTAttachment_DocPK)
		End If
  End Sub
	<System.Web.Services.WebMethod()> _
  Public Shared Function validate_FK_LG_WTAttachment_DocPK(ByVal value As String) As String
