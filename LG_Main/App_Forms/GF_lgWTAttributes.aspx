<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="GF_lgWTAttributes.aspx.vb" Inherits="GF_lgWTAttributes" title="Maintain List: WT Attributes" %>
