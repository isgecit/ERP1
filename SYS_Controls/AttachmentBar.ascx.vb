Partial Class AttachmentBar
	...
	Public Property AttachVisible() As Boolean
		...
		End Set
	End Property
	Protected Sub cmdAttach_Clicked(ByVal sender As Object, ByVal args As EventArgs)
		RaiseAttachClicked(sender, args)
	End Sub
